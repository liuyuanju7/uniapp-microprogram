<template>
	<view>
		...
		<view style="padding-bottom: 50px;">
			<!-- <mp-html ref="article" class="ccc" container-style="padding:20px" :content="content" domain="https://6874-html-foe72-1259071903.tcb.qcloud.la/demo" :editable="editable"  /> -->
		</view>
		<block v-if="modal">
			<view class="mask" />
			<view class="modal">
