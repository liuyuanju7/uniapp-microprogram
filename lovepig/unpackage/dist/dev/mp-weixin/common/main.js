...
/***/ 0:
/*!***************************************************************************!*\
  !*** /Users/liuyuanju1/study/git-hub/uniapp-microprogram/lovepig/main.js ***!
  \***************************************************************************/
...
var _pig = _interopRequireDefault(__webpack_require__(/*! @/common/pig.js */ 68));
var _store = _interopRequireDefault(__webpack_require__(/*! @/store */ 33));
var _httpInterceptor = _interopRequireDefault(__webpack_require__(/*! @/common/http.interceptor.js */ 73));
var _httpApi = _interopRequireDefault(__webpack_require__(/*! @/common/http.api.js */ 74));
...
//全局变量
_vue.default.prototype.appid = 'wx34dfb777ec6e2402';

// 引入全局uView

_vue.default.use(_uviewUi.default);
_vue.default.use(_pig.default);
...
/***/ 27:
/*!***************************************************************************!*\
  !*** /Users/liuyuanju1/study/git-hub/uniapp-microprogram/lovepig/App.vue ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ 28:
/*!****************************************************************************************************!*\
  !*** /Users/liuyuanju1/study/git-hub/uniapp-microprogram/lovepig/App.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 29:
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/liuyuanju1/study/git-hub/uniapp-microprogram/lovepig/App.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              loginData = uni.getStorageSync('userInfo');
              if (token && loginData) {
                console.info('查找到用户信息直接登录');
                _index.default.commit('modifyToken', token);
                _index.default.dispatch('updateLoginUser', loginData);
  ...
  computed: _objectSpread({}, (0, _vuex.mapGetters)(['getLoginUser'])),
  methods: {
    ...
    wechatLogin: function wechatLogin(code) {
      this.$u.api.wechatLogin({
        ...
        // console.info(res)
        if (res.newUser) {
          _index.default.commit('modifyIsNewUser', true);
          console.info('该用户是新用户需要获取信息登录');
        } else {
          //把token放到缓存中
          _index.default.commit('modifyToken', res.token);
          _index.default.commit('modifyLoginUser', res.loginUser);
          // this.navigatePath();
        }
      });
    },
    navigatePath: function navigatePath(loginData) {
    ...
    h5DevLogin: function h5DevLogin() {
      if (true) {
        var tokentemp = "wx eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyVVVJRCI6ImU1NzUzMzUwLTZhNmQtNGQyMi05NmRmLTFiNzBjMjVlYWYzOCJ9.1muLZfeQKsax3-pKASKYmtk2m_S9ZUxXjNYGJCUd43I";
        var usertemp = '{"id":25,"username":"pig_xy79e91ntf","gender":0,"nickname":"joke","avatar":"https://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLLnsXvmY93UaEB9M1JIaNNjdI243VX5v5ekpuiaNzBDTzJKL4KGLoLR4nKkwf39v2XChWD0JMc0eA/132","signature":"","city":"","loveId":536,"spouseId":255,"state":0,"createTime":1648290437000,"modifyTime":1653230616000}';
        console.info('h5开发者登录');
        uni.setStorageSync('token', tokentemp);
        uni.setStorageSync('userInfo', JSON.parse(usertemp));
        _index.default.commit('modifyToken', tokentemp);
        _index.default.dispatch('updateLoginUser', JSON.parse(usertemp));
...
/***/ 39:
/*!*************************************************************************************************************!*\
  !*** /Users/liuyuanju1/study/git-hub/uniapp-microprogram/lovepig/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 40:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/liuyuanju1/study/git-hub/uniapp-microprogram/lovepig/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
